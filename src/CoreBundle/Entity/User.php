...
class User implements AdvancedUserInterface, \Serializable
{
     ...
     * @Assert\NotBlank()
     *
     * @ORM\OneToOne(targetEntity="CoreBundle\Entity\Profile", mappedBy="user", cascade={"all"})
     **/
    protected $profile;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="CoreBundle\Entity\UserAction", mappedBy="user", cascade={"all"})
     */
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="CoreBundle\Entity\UserRecoveryCode", mappedBy="user", cascade={"all"})
     */
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="CoreBundle\Entity\UserDevice", mappedBy="user", cascade={"all"})
     */
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="CoreBundle\Entity\UserLoginCode", mappedBy="user", cascade={"all"})
     */
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="CoreBundle\Entity\UserBlockedAction", mappedBy="user", cascade={"all"})
     */
