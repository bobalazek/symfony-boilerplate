 ...
 * @ORM\Entity(repositoryClass="CoreBundle\Repository\UserRecoveryCodeRepository")
 *
...
class UserRecoveryCode
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CoreBundle\Entity\User", inversedBy="userRecoveryCodes")
     */
    protected $user;
